...
BOOST_DIR  ?=/NAS/share/program/lib/boost_1_60_0
PARSA_ROOT ?=/NAS/share/program/lib/neoParSA_0.4
...
src/main/transcpp.o: src/main/transcpp.cpp
	$(CXX) -c $(FLAGS)  -fPIE -pie -Isrc/ src/main/transcpp.cpp -o src/main/transcpp.o
	
src/main/ptranscpp.o: src/main/ptranscpp.cpp
	$(MPICXX) -c $(FLAGS) -fPIE -pie -Isrc/ src/main/ptranscpp.cpp -DUSE_BOOST -o src/main/ptranscpp.o
	
src/main/scramble.o: src/main/scramble.cpp
	$(CXX) -c $(FLAGS) -fPIE -pie -Isrc/ src/main/scramble.cpp -o src/main/scramble.o
